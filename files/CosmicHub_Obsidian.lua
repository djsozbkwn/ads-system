...
TweenSpeed = 360  -- studs/sec; controlled by Settings slider

local movementPos1, movementPos2, movementTarget, movementGoingTo1, movementLooping = nil, nil, nil, true, false
local movementConn
            ...
            if IslandESP then
                if vu26.Name ~= "Sea" then
                    if vu26:FindFirstChild("NameEsp") then
                        ...
                        v28.FontSize = Enum.FontSize.Size14
            ...
            if not isnil(vu36.Character) then
                if ESPPlayer then
                    if isnil(vu36.Character.Head) or vu36.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v38.FontSize = Enum.FontSize.Size14
                        ...
                        v38.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if vu60.Name == "Flower2" or vu60.Name == "Flower1" then
                if FlowerESP then
                    if vu60:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v62.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v66:IsA("Tool") then
            if RealFruitESP then
                if v66.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v68.FontSize = Enum.FontSize.Size14
                    v68.TextWrapped = true
                    v68.Size = UDim2.new(1, 0, 1, 0)
                    v68.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v72:IsA("Tool") then
            if RealFruitESP then
                if v72.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v74.FontSize = Enum.FontSize.Size14
        ...
        if v78:IsA("Tool") then
            if RealFruitESP then
                if v78.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v80.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if not isnil(vu95.Character) then
                if ESPPlayer then
                    if isnil(vu95.Character.Head) or vu95.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v97.FontSize = Enum.FontSize.Size14
                        ...
                        v97.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if _G.ChestESP then
                if not vu102:GetAttribute("IsDisabled") then
                    if vu102:FindFirstChild("ChestEsp") then
                        ...
                        v106.Font = Enum.Font.Code
                        v106.FontSize = Enum.FontSize.Size14
            ...
            if DevilFruitESP then
                if string.find(vu112.Name, "Fruit") then
                    if vu112.Handle:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v114.FontSize = Enum.FontSize.Size14
            ...
            if vu119.Name == "Flower2" or vu119.Name == "Flower1" then
                if FlowerESP then
                    if vu119:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v121.FontSize = Enum.FontSize.Size14
        ...
        if v125:IsA("Tool") then
            if RealFruitESP then
                if v125.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v127.FontSize = Enum.FontSize.Size14
                    v127.TextWrapped = true
                    v127.Size = UDim2.new(1, 0, 1, 0)
                    v127.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v131:IsA("Tool") then
            if RealFruitESP then
                if v131.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v133.FontSize = Enum.FontSize.Size14
                    v133.TextWrapped = true
                    v133.Size = UDim2.new(1, 0, 1, 0)
                    v133.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v137:IsA("Tool") then
            if RealFruitESP then
                if v137.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v139.FontSize = Enum.FontSize.Size14
            ...
            if IslandESP then
                if vu144.Name ~= "Sea" then
                    if vu144:FindFirstChild("NameEsp") then
                        ...
                        v146.Font = Enum.Font.GothamSemibold
                        v146.FontSize = Enum.FontSize.Size14
                        v146.TextWrapped = true
                        v146.Size = UDim2.new(1, 0, 1, 0)
                        v146.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if not isnil(vu154.Character) then
                if ESPPlayer then
                    if isnil(vu154.Character.Head) or vu154.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v156.FontSize = Enum.FontSize.Size14
                        ...
                        v156.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if _G.ChestESP then
                if not vu161:GetAttribute("IsDisabled") then
                    if vu161:FindFirstChild("ChestEsp") then
                        ...
                        v165.Font = Enum.Font.Code
                        v165.FontSize = Enum.FontSize.Size14
                        v165.TextWrapped = true
                        v165.Size = UDim2.new(1, 0, 1, 0)
                        v165.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if DevilFruitESP then
                if string.find(vu171.Name, "Fruit") then
                    if vu171.Handle:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v173.FontSize = Enum.FontSize.Size14
                        v173.TextWrapped = true
                        v173.Size = UDim2.new(1, 0, 1, 0)
                        v173.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v184:IsA("Tool") then
            if RealFruitESP then
                if v184.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v186.FontSize = Enum.FontSize.Size14
                    v186.TextWrapped = true
                    v186.Size = UDim2.new(1, 0, 1, 0)
                    v186.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v196:IsA("Tool") then
            if RealFruitESP then
                if v196.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v198.FontSize = Enum.FontSize.Size14
                    v198.TextWrapped = true
                    v198.Size = UDim2.new(1, 0, 1, 0)
                    v198.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if IslandESP then
                if vu203.Name ~= "Sea" then
                    if vu203:FindFirstChild("NameEsp") then
                        ...
                        v205.Font = Enum.Font.GothamSemibold
                        v205.FontSize = Enum.FontSize.Size14
                        v205.TextWrapped = true
                        v205.Size = UDim2.new(1, 0, 1, 0)
                        v205.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if not isnil(vu213.Character) then
                if ESPPlayer then
                    if isnil(vu213.Character.Head) or vu213.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v215.FontSize = Enum.FontSize.Size14
                        ...
                        v215.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if vu237.Name == "Flower2" or vu237.Name == "Flower1" then
                if FlowerESP then
                    if vu237:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v239.FontSize = Enum.FontSize.Size14
                        v239.TextWrapped = true
                        v239.Size = UDim2.new(1, 0, 1, 0)
                        v239.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v243:IsA("Tool") then
            if RealFruitESP then
                if v243.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v245.FontSize = Enum.FontSize.Size14
                    v245.TextWrapped = true
                    v245.Size = UDim2.new(1, 0, 1, 0)
                    v245.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if IslandESP then
                if vu262.Name ~= "Sea" then
                    if vu262:FindFirstChild("NameEsp") then
                        ...
                        v264.Font = Enum.Font.GothamSemibold
                        v264.FontSize = Enum.FontSize.Size14
            ...
            if not isnil(vu272.Character) then
                if ESPPlayer then
                    if isnil(vu272.Character.Head) or vu272.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v274.FontSize = Enum.FontSize.Size14
            ...
            if _G.ChestESP then
                if not vu279:GetAttribute("IsDisabled") then
                    if vu279:FindFirstChild("ChestEsp") then
                        ...
                        v283.Font = Enum.Font.Code
                        v283.FontSize = Enum.FontSize.Size14
                        v283.TextWrapped = true
                        v283.Size = UDim2.new(1, 0, 1, 0)
                        v283.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if DevilFruitESP then
                if string.find(vu289.Name, "Fruit") then
                    if vu289.Handle:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v291.FontSize = Enum.FontSize.Size14
                        v291.TextWrapped = true
                        v291.Size = UDim2.new(1, 0, 1, 0)
                        v291.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if vu296.Name == "Flower2" or vu296.Name == "Flower1" then
                if FlowerESP then
                    if vu296:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v298.FontSize = Enum.FontSize.Size14
                        v298.TextWrapped = true
                        v298.Size = UDim2.new(1, 0, 1, 0)
                        v298.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v302:IsA("Tool") then
            if RealFruitESP then
                if v302.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v304.FontSize = Enum.FontSize.Size14
                    v304.TextWrapped = true
                    v304.Size = UDim2.new(1, 0, 1, 0)
                    v304.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v308:IsA("Tool") then
            if RealFruitESP then
                if v308.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v310.FontSize = Enum.FontSize.Size14
                    v310.TextWrapped = true
                    v310.Size = UDim2.new(1, 0, 1, 0)
                    v310.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if IslandESP then
                if vu321.Name ~= "Sea" then
                    if vu321:FindFirstChild("NameEsp") then
                        ...
                        v323.Font = Enum.Font.GothamSemibold
                        v323.FontSize = Enum.FontSize.Size14
                        v323.TextWrapped = true
                        v323.Size = UDim2.new(1, 0, 1, 0)
                        v323.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if not isnil(vu331.Character) then
                if ESPPlayer then
                    if isnil(vu331.Character.Head) or vu331.Character.Head:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v333.FontSize = Enum.FontSize.Size14
                        ...
                        v333.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if _G.ChestESP then
                if not vu338:GetAttribute("IsDisabled") then
                    if vu338:FindFirstChild("ChestEsp") then
                        ...
                        v342.Font = Enum.Font.Code
                        v342.FontSize = Enum.FontSize.Size14
                        v342.TextWrapped = true
                        v342.Size = UDim2.new(1, 0, 1, 0)
                        v342.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if DevilFruitESP then
                if string.find(vu348.Name, "Fruit") then
                    if vu348.Handle:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v350.FontSize = Enum.FontSize.Size14
            ...
            if vu355.Name == "Flower2" or vu355.Name == "Flower1" then
                if FlowerESP then
                    if vu355:FindFirstChild("NameEsp" .. Number) then
                        ...
                        v357.FontSize = Enum.FontSize.Size14
                        v357.TextWrapped = true
                        v357.Size = UDim2.new(1, 0, 1, 0)
                        v357.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v361:IsA("Tool") then
            if RealFruitESP then
                if v361.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v363.FontSize = Enum.FontSize.Size14
                    v363.TextWrapped = true
                    v363.Size = UDim2.new(1, 0, 1, 0)
                    v363.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v367:IsA("Tool") then
            if RealFruitESP then
                if v367.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v369.FontSize = Enum.FontSize.Size14
                    v369.TextWrapped = true
                    v369.Size = UDim2.new(1, 0, 1, 0)
                    v369.TextYAlignment = Enum.TextYAlignment.Top
        ...
        if v373:IsA("Tool") then
            if RealFruitESP then
                if v373.Handle:FindFirstChild("NameEsp" .. Number) then
                    ...
                    v375.FontSize = Enum.FontSize.Size14
                    v375.TextWrapped = true
                    v375.Size = UDim2.new(1, 0, 1, 0)
                    v375.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if MirageIslandESP then
                if vu416.Name == "Mirage Island" then
                    if vu416:FindFirstChild("NameEsp") then
                        ...
                        v418.Font = Enum.Font.Code
                        v418.FontSize = Enum.FontSize.Size14
                        v418.TextWrapped = true
                        v418.Size = UDim2.new(1, 0, 1, 0)
                        v418.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if PrehistoricIslandESP then
                if vu423.Name == "PrehistoricIsland" then
                    if vu423:FindFirstChild("NameEsp") then
                        ...
                        v425.Font = Enum.Font.Code
                        v425.FontSize = Enum.FontSize.Size14
                        v425.TextWrapped = true
                        v425.Size = UDim2.new(1, 0, 1, 0)
                        v425.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if AuraESP then
                if vu437.Name == "Master of Enhancement" then
                    if vu437:FindFirstChild("NameEsp") then
                        ...
                        v439.Font = Enum.Font.Code
                        v439.FontSize = Enum.FontSize.Size14
                        v439.TextWrapped = true
                        v439.Size = UDim2.new(1, 0, 1, 0)
                        v439.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if LADESP then
                if vu444.Name == "Legendary Sword Dealer" then
                    if vu444:FindFirstChild("NameEsp") then
                        ...
                        v446.Font = Enum.Font.Code
                        v446.FontSize = Enum.FontSize.Size14
                        v446.TextWrapped = true
                        v446.Size = UDim2.new(1, 0, 1, 0)
                        v446.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if GearESP then
                if vu453.Name == "MeshPart" then
                    if vu453:FindFirstChild("NameEsp") then
                        ...
                        v455.Font = Enum.Font.Code
                        v455.FontSize = Enum.FontSize.Size14
                        v455.TextWrapped = true
                        v455.Size = UDim2.new(1, 0, 1, 0)
                        v455.TextYAlignment = Enum.TextYAlignment.Top
            ...
            if KitsuneIslandEsp then
                if vu476.Name == "Kitsune Island" then
                    if vu476:FindFirstChild("NameEsp") then
                        ...
                        v478.Font = Enum.Font.Code
                        v478.FontSize = Enum.FontSize.Size14
                        v478.TextWrapped = true
                        v478.Size = UDim2.new(1, 0, 1, 0)
                        v478.TextYAlignment = Enum.TextYAlignment.Top
...
function topos(p540)
    ...
    if vu541.Character and vu541.Character.Humanoid.Health > 0 and vu541.Character:FindFirstChild("HumanoidRootPart") then
        ...
        vu523 = true
        local v547 = game:GetService("TweenService"):Create(vu541.Character.PartTele, TweenInfo.new(v542 / TweenSpeed, Enum.EasingStyle.Linear), {
            ["CFrame"] = p540
        })
        v547:Play()
...
function TP13(p561)
    ...
    local vu563 = game:GetService("TweenService"):Create(
        game:GetService("Players").LocalPlayer.Character.HumanoidRootPart,
        TweenInfo.new(v562 / TweenSpeed, Enum.EasingStyle.Linear),
        { ["CFrame"] = p561 }
    )
    vu563:Play()
    function vu560.Stop(_)
        pcall(function() vu563:Cancel() end)
    end
    return vu560
end
...
-- â   â¦ COSMIC HUB  Â·  Obsidian Edition  â¦    â
-- ââââââââââââââââââââââââââââââââââââââââââââââââââââ

local _repo    = "https://raw.githubusercontent.com/deividcomsono/Obsidian/main/"
local Library  = loadstring(game:HttpGet(_repo .. "Library.lua"))()
local Options  = Library.Options
local Toggles  = Library.Toggles

-- IMPORTANT: Do NOT replace Library.Scheme with a new table.
-- Obsidian captures an internal reference to the Scheme table at load-time,
-- so reassigning Library.Scheme = {} leaves the internal copy unchanged.
-- We must update the EXISTING table in-place.
-- Also: Font/string values must NEVER be in Scheme â FillInstance blindly
-- assigns every key as a GUI property; putting a Font/string there causes
-- "Color3 expected, got string" on any Color-typed property.
do
    local s = Library.Scheme
    -- Wipe any string/non-Color3 values that may exist in the default scheme
    for k, v in pairs(s) do
        if typeof(v) ~= "Color3" then
            s[k] = nil
        end
    end
    s.BackgroundColor = Color3.fromRGB(10,  0,  20)
    s.MainColor       = Color3.fromRGB(18,  0,  36)
    s.AccentColor     = Color3.fromRGB(140, 30, 255)
    s.Color           = Color3.fromRGB(55,  0, 100)
    s.FontColor       = Color3.new(1, 1, 1)
end
-- SetFont AFTER scheme is clean (some Obsidian builds store font inside Scheme)
pcall(function() Library:SetFont(Enum.Font.GothamBold) end)

local _Window = Library:CreateWindow({
    Title           = "â¦ Cosmic Blox Fruitsâ¦",
    Footer          = "discord.gg/cosmicsys  Â·  COSMIC v1.0",
    Center          = true,
    AutoShow        = true,
...
--  SHIM:  Shim API  â  Obsidian API
--
--  Strategy:
--    Â· Each MakeTab() call returns a tab-object.
--    Â· AddSection()   creates a new LEFT GroupBox with that name
--                     (sections map naturally to groupboxes).
--    Â· All elements   go into the CURRENT groupbox.
--    Â· If AddToggle/Button/etc is called before any
--      AddSection, an "auto" groupbox is created first.
--    Â· AddParagraph() returns a shim with :Set(v) that
--      calls label:SetText(v) â no more nil-crash.
--    Â· Unique indices use a monotonic counter to avoid
--      any duplicate-flag issues.
-- âââââââââââââââââââââââââââââââââââââââââââââââââââ

local _idx = 0
local function _newIdx()
    _idx = _idx + 1
    return "obs_" .. _idx
end

-- Tab map: variable name â Obsidian Tab
local _tabs = {}

local vu616 = {}

function vu616.MakeTab(_, args)
    local tabName = (type(args) == "table" and args[1]) or tostring(args)
    local icon    = (type(args) == "table" and args[2]) or "home"

    -- Obsidian icon is a Lucide name string; rbxassetid:// strings fallback to "home"
    if type(icon) == "string" and icon:find("rbxassetid") then
        icon = "home"
    end

    local _obsTab = _Window:AddTab(tabName, icon)

    local _currentBox  = nil   -- current GroupBox (changes per AddSection)
    local _labelCount  = 0     -- paragraph labels in this tab

    local function _ensureBox()
        if not _currentBox then
            _currentBox = _obsTab:AddLeftGroupbox(tabName)
        end
    end

    local _obj = {}

    -- AddSection â new GroupBox
    function _obj:AddSection(a)
        local name = (type(a) == "table" and (a[1] or a.Title or a.Name or ""))
                     or tostring(a)
        _currentBox = _obsTab:AddLeftGroupbox(name)
    end
    ...
    function _obj:AddToggle(a)
        _ensureBox()
        local idx = _newIdx()
        _currentBox:AddToggle(idx, {
            Text     = a.Name  or a.Title or "",
            Tooltip  = a.Description or nil,
            Default  = a.Default or a.Value or false,
    ...
    function _obj:AddButton(a)
        _ensureBox()
        _currentBox:AddButton({
            Text    = a.Title or a.Name or "",
            Tooltip = a.Description or nil,
            Func    = a.Callback or function() end,
        })
    end
    ...
    function _obj:AddDropdown(a)
        _ensureBox()
        local idx = _newIdx()
        local vals = a.Options or a.Values or {}
        local def  = a.Default
        -- Obsidian Default accepts string or numeric index
        _currentBox:AddDropdown(idx, {
            Text     = a.Name  or a.Title or "",
            Tooltip  = a.Description or nil,
            Values   = vals,
            Default  = def,
    ...
    function _obj:AddSlider(a)
        _ensureBox()
        local idx = _newIdx()
        _currentBox:AddSlider(idx, {
            Text      = a.Title or a.Name or "",
            Tooltip   = a.Description or nil,
            Default   = a.Default or a.Min or 0,
            Min       = a.Min or 0,
            Max       = a.Max or 100,
            Rounding  = a.Increment and 0 or 0,
            Callback  = a.Callback or function() end,
        })
    end

    -- AddParagraph â label with working :Set()
    function _obj:AddParagraph(a)
        _ensureBox()
        _labelCount = _labelCount + 1
        local idx     = _newIdx()
        local title   = a.Title   or ""
        local content = a.Content or ""
        local display = (title ~= "" and (title .. ": " .. content)) or content

        _currentBox:AddLabel(idx, {
            Text     = display,
            DoesWrap = true,
        })

        -- Return shim so all existing :Set(val) calls work
        local _shim = {}
        function _shim:Set(val)
            pcall(function()
                local newText = (title ~= "" and (title .. ": " .. tostring(val))) or tostring(val)
                Options[idx]:SetText(newText)
            end)
        end
        return _shim
    end
...
function vu616:Minimize(_) end   -- Obsidian has its own toggle; safe no-op

-- ââ Tab declarations (match original variable names exactly) ââ
local v631 = vu616
...
task.spawn(function()
    ...
    while task.wait(1) do
        pcall(function()
            ...
            vu707:Set("Status: " .. v712 .. " Eye(s)" .. (v712 == 4 and " " or ""))
        end)
    end
end)
v632:AddToggle({
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if _G.SelectBoss and (game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss)) then
                vu839:Set("Status: Boss Spawn ")
            else
                vu839:Set("Status: Boss Not Spawn ")
            end
        end)
    end
end)
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                vu1070:Set("Prehistoric Island Spawning ")
            else
                vu1070:Set("Prehistoric Island Not Spawn ")
            end
        end)
    end
end)
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
                vu1181:Set("Kitsune Island Spawning ")
            else
                vu1181:Set("Kitsune Island Not Spawn ")
            end
        end)
    end
end)
    ...
    while task.wait(1) do
        pcall(function()
            ...
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                vu1251:Set("Mirage Island Spawning ")
            else
                vu1251:Set("Mirage Island Not Spawn ")
            end
        end)
    end
end)
...
local function vu1398()
    ...
    if v1381 and v1382 then
        ...
        if not v1386 then
            v1380 = v1380 .. "- Khng c tri no.\n"
        end
    else
        v1380 = v1380 .. "-  Li khi ly d liu.\n"
    end
    local v1389 = v1380 .. "\nNormal Fruit Stock\n"
    ...
    if v1390 and v1391 then
        ...
        if not v1395 then
            v1389 = v1389 .. "- Khng c tri no.\n"
        end
    else
        v1389 = v1389 .. "-  Li khi ly d liu.\n"
    end
    return v1389
end
local vu1399 = v646:AddParagraph({
    ["Title"] = "Stock Tri Cy",
    ["Content"] = "ang ti d liu..."
})
task.spawn(function()
...
v648:AddSection({
    "Teleport Sea | Di Chuyn Sea 1,2,3"
})
v648:AddButton({
    ["Name"] = "Sea 1",
    ["Callback"] = function()
...
v648:AddToggle({
    ["Name"] = "Enable Loop movement",
    ["Default"] = false,
    ["Callback"] = function(state)
        _G.MovementLoopEnabled = state
        if _G.MovementLoopEnabled then
            if movementConn then movementConn:Disconnect() end
            movementConn = game:GetService("RunService").RenderStepped:Connect(function()
                if _G.MovementLoopEnabled then
                    local char = game.Players.LocalPlayer.Character
                    local hrp = char and char:FindFirstChild("HumanoidRootPart")
                    if hrp and movementTarget then
                        local dir = (movementTarget - hrp.Position)
                        if dir.Magnitude > 2 then
                            hrp.Velocity = dir.Unit * 200
                        else
                            if movementLooping then
                                movementGoingTo1 = not movementGoingTo1
                                movementTarget = movementGoingTo1 and movementPos1 or movementPos2
                            else
                                movementTarget = nil
                            end
                        end
...
v648:AddButton({
    ["Name"] = "Start Loop",
    ["Callback"] = function()
        if movementPos1 and movementPos2 then
            movementLooping = true
            movementGoingTo1 = true
            movementTarget = movementPos1
        end
    end
})

v650:AddSection({
    "Teleport Player | Di Chuyn n Player"
})
